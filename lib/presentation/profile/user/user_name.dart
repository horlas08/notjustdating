...
@RoutePage()
class UserNameUserPage extends StatefulWidget {
  const UserNameUserPage({super.key, this.userType, this.firstName});
  final String? userType;
  final String? firstName;

  @override
  State<UserNameUserPage> createState() => _UserNameUserPageState();
}

class _UserNameUserPageState extends State<UserNameUserPage> {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                        "Choose a username, or take our friendly suggestions, you can update it when ever you like.",
                        style: TextStyle(
                            fontFamily: Font.inter,
                            fontSize: 16.sp,
                            color: Colors.black,
                  ...
                  children: [
                    CustomButton(
                      ...
                      onPressed: model.isEditNameButtonActive
                          ? () {
                              getIt<AppRouter>().push(PhotosSelectionRoute(
                                  fullName: widget.firstName,
                                  userName: controller.text));
                              log("firstName :::: ${widget.firstName}");
                              log("username :::: ${controller.text}");
                            }
                          : null,
                      child: Text("Next",
                          style: TextStyle(
