...
import 'package:ofwhich_v2/presentation/user_profile/edit_profile/user/model/smoking_model.dart';
...
@RoutePage()
class EditSmoking extends StatefulWidget {
  const EditSmoking({super.key});

  @override
  State<EditSmoking> createState() => _EditSmokingState();
}

class _EditSmokingState extends State<EditSmoking> {
  int currentIndex = -1;
  @override
                ...
                Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      shrinkWrap: true,
                      itemCount: smokingTypes.length,
                      physics: const NeverScrollableScrollPhysics(),
                      itemBuilder: (context, index) {
                        SmokingModel so = smokingTypes[index];
                  ...
                  children: [
                    CustomButton(
                      ...
                      onPressed:
                          ...
                          () {
                        model.editProfile(
                            smokes: smokingTypes[currentIndex]
                                .value
                                .toLowerCase()
                                .trim(),
                            navigate: () {
...
class SelectionWidget extends StatelessWidget {
  ...
  final SmokingModel smokingModel;
