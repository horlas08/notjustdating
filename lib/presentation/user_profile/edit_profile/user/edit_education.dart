...
import 'package:ofwhich_v2/presentation/user_profile/edit_profile/user/model/education_model.dart';
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        EducationModel so = educationList[index];
                  ...
                  children: [
                    CustomButton(
                      ...
                      onPressed:
                          ...
                          () {
                        model.editProfile(
                            education_level: educationList[currentIndex]
                                .value
                                .toLowerCase()
                                .trim(),
                            navigate: () {
...
class SelectionWidget extends StatelessWidget {
  ...
  final EducationModel exerciseModel;
